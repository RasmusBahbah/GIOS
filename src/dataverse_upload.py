...
def to_netcdf(folder,area):
    ...
    date_f = folder.split(os.sep)[-1][-10:]
    date = date_f.replace("_","-")
    
    filename = f'SICEv3.0_{area}_500m_{date}.nc'
...
def dataverse_upload(folder,area,api_key):
